  ...
  useEffect(()=>{
    ...
    return (
      <div id='mainDiv' >
        ...
        <div id='MMenu' className='JD'>
          <div id='mobileMenu' className='JD'>
  
            <div id='bottomLeftMainDiv' className='JD'>
              <h1>Price</h1>
              <div class="range-input">
                <div></div>
            ...
            <div id='leftCheckboxDiv' className='JD'>
              <h1>Brand</h1>
            ...
            <div id='leftRatingDiv'  className='JD'>
                <h1>Rating</h1>
                <div id='Star5' className='rateStars'>
        ...
        <div id='mainMobileMenu' className='JM justMobileMenu'>
          <div id='mobileMMenu' className='JM'>
